...
export class AppStateService {
  private readonly localStorageKey = 'dayone-ng'; // Customize this key
  ...
  // Method to get a specific property from state
  ...
  private applyThemeBackgroundSpecificChanges(background: any) {
    ...
    html?.style.setProperty('--form-control-bg', `rgb(${background.accent})`);
