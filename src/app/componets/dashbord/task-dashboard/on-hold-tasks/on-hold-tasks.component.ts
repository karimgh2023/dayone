...
@Component({
  ...
  standalone: true,
  imports: [SharedModule,NgbModule,FlatpickrModule,NgSelectModule,NgApexchartsModule,MaterialModuleModule,FormsModule,ReactiveFormsModule,AngularEditorModule,RouterModule],
